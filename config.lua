...
Config.Shops = {
    ...
    {coords = vector3(24.03, -1345.63, 29.5-0.98), heading = 266.0, money = {500, 1000}, cops = 1, blip = true, name = '7/11', cooldown = {hour = 0, minute = 45, second = 0}, robbed = false, rob_time = 2000},
    {coords = vector3(-705.73, -914.91, 19.22-0.98), heading = 91.0, money = {600, 1200}, cops = 1, blip = true, name = '7/11', cooldown = {hour = 0, minute = 45, second = 0}, robbed = false, rob_time = 2000}
}
